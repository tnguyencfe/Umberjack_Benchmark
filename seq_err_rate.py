...
def count_mismatch(samfile):
    ...
    with open(samfile, 'rU') as fh:
        ...
        # "Sam", "Reads", "Bp",  "Aligned", "Match", "Mismatch", "Insert", "Deletion"
        outrow = dict(Sam=samfile,
                      Reads=total_reads,
                      Bp=total_bases,
                      Aligned=total_bases_aligned/total_bases,
                      Match=total_match/total_bases_aligned,
                      Mismatch=total_mismatch/total_bases_aligned,
                      Insert=total_insert/total_bases_aligned,
                      Delete=total_deletion/total_bases_aligned)
        return outrow
